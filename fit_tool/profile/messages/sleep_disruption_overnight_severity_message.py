...
# timestamp : milliseconds from January 1st, 1970 at 00:00:00 UTC
    ...
    @property
    def severity(self) -> Optional[SleepDisruptionSeverity]:
        field = self.get_field(SleepDisruptionOvernightSeveritySeverityField.ID)
        if field and field.is_valid():
            sub_field = field.get_valid_sub_field(self.fields)
            return field.get_value(sub_field=sub_field)
        else:
    ...
    @severity.setter
    def severity(self, value: SleepDisruptionSeverity):
        field = self.get_field(SleepDisruptionOvernightSeveritySeverityField.ID)
...
class SleepDisruptionOvernightSeveritySeverityField(Field):
    ID = 0
