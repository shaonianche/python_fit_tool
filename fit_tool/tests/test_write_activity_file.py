...
def test_write_activity_file_iteratively():
    ...
    out_path = "fit_tool/tests/out/activity_iterative.fit"
...
def test_write_activity_with_developer_data_fields():
    ...
    out_path = "fit_tool/tests/out/activity_with_developer_data.fit"

    fit_file.to_file(out_path)
    csv_path = "fit_tool/tests/out/activity_with_developer_data.csv"
